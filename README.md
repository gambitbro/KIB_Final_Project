...
## 2024-06-26(수)
    ● Arduino boad => 블루투스 연결하여 신호 왔다갔다 하는지 테스트
    ● 스마트팜 외형 1차 제작
- ![1차 제작](image/KakaoTalk_20240626_173626872.jpg)
## 2024-06-27(목)
    ● 회의
...
## 2024-07-01(월)
    ...
    ● 메가 보드의 와이파이 모듈(ESP8266)을 통해 Google Cloud DB에 센서 데이터를 저장하기 위한 php 코드     작성 및 VM 인스턴스 생성하여 php 파일 업로드(SCP, FTP 등). permission denied(public key) 오류로 인해 VM 인스턴스의 /var/www/html 경로 안에 insert_data.php 파일 직접 작성하여 저장.
...
## 2024-07-03(수)
    ● 회의
    ● 서류작성 (회의록, 품의서, 팀지원금 지출 결과서, 지원비 관련 엑셀 문서, 팀 결과 보고서)
